...
/**
 * #### Generated from [ReSharperAbpModel.kt:9]
 */
class ReSharperAbpModel private constructor(
    ...
    private val _func: RdCall<MyEnum?, String>
) : RdExtBase() {
    //companion
    ...
    companion object : ISerializersOwner {
        ...
        const val serializationHash = -3810063502805418698L
        
    }
    override val serializersOwner: ISerializersOwner get() = ReSharperAbpModel
    override val serializationHash: Long get() = ReSharperAbpModel.serializationHash
    ...
    val func: IRdCall<MyEnum?, String> get() = _func
    //methods
    //initializer
    init {
    ...
    init {
        ...
        bindableChildren.add("func" to _func)
    }
    ...
    internal constructor(
        ...
        RdCall<MyEnum?, String>(__MyEnumNullableSerializer, FrameworkMarshallers.String)
    )
    ...
    override fun print(printer: PrettyPrinter)  {
        printer.println("ReSharperAbpModel (")
        printer.indent {
            ...
            print("func = "); _func.print(printer); println()
        }
        printer.print(")")
    }
    //deepClone
    override fun deepClone(): ReSharperAbpModel   {
        return ReSharperAbpModel(
            ...
            _func.deepClonePolymorphic()
        )
    }
    //contexts
}
val Solution.reSharperAbpModel get() = getOrCreateExtension("reSharperAbpModel", ::ReSharperAbpModel)



/**
 * #### Generated from [ReSharperAbpModel.kt:11]
 */
enum class MyEnum {
    FirstValue, 
    SecondValue;
...
/**
 * #### Generated from [ReSharperAbpModel.kt:16]
 */
