...
namespace JetBrains.Rider.Model
{
  ...
  /// <summary>
  /// <p>Generated from: ReSharperAbpModel.kt:9</p>
  /// </summary>
  public class ReSharperAbpModel : RdExtBase
  {
    //fields
    //public fields
    ...
    [NotNull] public IRdEndpoint<JetBrains.Rider.Model.MyEnum?, string> Func => _Func;
    ...
    [NotNull] private readonly RdCall<JetBrains.Rider.Model.MyEnum?, string> _Func;
    
    //primary constructor
    private ReSharperAbpModel(
      ...
      [NotNull] RdCall<JetBrains.Rider.Model.MyEnum?, string> func
    )
    {
      ...
      BindableChildren.Add(new KeyValuePair<string, object>("func", _Func));
    }
    //secondary constructor
    internal ReSharperAbpModel (
    ) : this (
      ...
      new RdCall<JetBrains.Rider.Model.MyEnum?, string>(ReadMyEnumNullable, WriteMyEnumNullable, JetBrains.Rd.Impl.Serializers.ReadString, JetBrains.Rd.Impl.Serializers.WriteString)
    ) {}
    //deconstruct trait
    //statics
    ...
    protected override long SerializationHash => -3810063502805418698L;
    ...
    public override void Print(PrettyPrinter printer)
    {
      ...
      using (printer.IndentCookie()) {
        ...
        printer.Print("func = "); _Func.PrintEx(printer); printer.Println();
      }
      printer.Print(")");
    }
    //toString
  ...
  public static class SolutionReSharperAbpModelEx
   {
    public static ReSharperAbpModel GetReSharperAbpModel(this Solution solution)
    {
      return solution.GetOrCreateExtension("reSharperAbpModel", () => new ReSharperAbpModel());
    }
  }
  
  
  /// <summary>
  /// <p>Generated from: ReSharperAbpModel.kt:11</p>
  /// </summary>
  public enum MyEnum {
    FirstValue,
    SecondValue
  ...
  /// <summary>
  /// <p>Generated from: ReSharperAbpModel.kt:16</p>
  /// </summary>
